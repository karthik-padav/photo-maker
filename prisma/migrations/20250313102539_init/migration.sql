...
CREATE TABLE `Controler` (
    ...
    `imageWrapperSize` VARCHAR(191) NULL,
    `rotate` VARCHAR(191) NULL,
    `scale` VARCHAR(191) NULL,
    `pngShadow` VARCHAR(191) NULL,
    `transformX` VARCHAR(191) NULL,
    `transformY` VARCHAR(191) NULL,
    `pngBorderColor` VARCHAR(191) NULL,
    `outerBorderColor` VARCHAR(191) NULL,
    `outerBorderOpacity` VARCHAR(191) NULL,
    `outerBorderWidth` VARCHAR(191) NULL,
    `backgroundScale` VARCHAR(191) NULL,
    `backgroundColorType` VARCHAR(191) NULL,
    `backgroundColor` VARCHAR(191) NULL,
    `backgroundImagePath` VARCHAR(191) NULL,
    `backgroundRotate` VARCHAR(191) NULL,
    `downloadedImagePath` VARCHAR(191) NULL,
    `isActive` BOOLEAN NOT NULL DEFAULT true,
    `createdAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),
    `updatedAt` DATETIME(3) NOT NULL DEFAULT CURRENT_TIMESTAMP(3),

    INDEX `Controler_userId_idx`(`userId`),
    PRIMARY KEY (`id`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
