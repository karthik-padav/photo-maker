const ppmConstants = {
  ...
  landingPage: {
    ...
    whyOurWebsite: {
      heading: `Why Profile Picture Maker?`,
      list: [
        {
    ...
    detailedList: [
      {
        ...
        desc: `Profile Picture Maker makes it easy for anyone to design a unique and professional logo, regardless of design experience.`,
      },
      {
      ...
      {
        title: `Effortless logo creation with Profile Picture Maker`,
      ...
      },
      {
        ...
        desc: `Whether you need a logo for your business, personal project, or event, Profile Picture Maker provides the quality and flexibility you need.`,
      },
    ],
    faq: [
      {
        q: `Do I need any design experience to use Profile Picture Maker?`,
        a: `No, Profile Picture Maker is designed for users of all skill levels. Our intuitive interface and easy-to-use tools make it simple for anyone to create a professional logo.`,
      },
...

      {
        ...
        a: `No, there are no limits on the number of logos you can create and download with Profile Picture Maker.`,
      },
